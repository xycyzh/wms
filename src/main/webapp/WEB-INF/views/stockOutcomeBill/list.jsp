...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $(".btn_audit").click(function () {
                ...
                createDialog("温馨提示", "确定要审核这条出库订单吗?", "warning", function () {
                    //发起ajax请求
                    $.ajax({
                        url: url,
                        type: "get",
    ...
    <title>叩丁狼教育PSS（演示版）-出库订单管理</title>
    <style>
        .alt td {
            ...
            <div class="ui_text_indent">
                <div id="box_border">
                    ...
                    <div id="box_center">
                        ...
                        仓库:<select class="ui_select01" name="depotId">
                        ...
                        <br>&nbsp;审核状态:<select class="ui_select01" name="status">
                        <option value="-1">请选择</option>
                            ...
                            <td>
                                <c:if test="${list.status==0}">
                                    <a href="javascript:;" class="btn_audit"
                                       data-url="/stockOutcomeBill/audit.do?id=${list.id}">审核</a>
                                    <a href="javascript:;" class="btn_redirect"
                                       data-url="/stockOutcomeBill/input.do?id=${list.id}">编辑</a>
                                    <a href="javascript:;" class="btn_delete"
                                       data-url="/stockOutcomeBill/delete.do?id=${list.id}"
                                       data-redirect="/stockOutcomeBill/list.do">删除</a>
                                </c:if>
                                <c:if test="${list.status==1}">
                                    <a href="javascript:;" class="btn_redirect"
                                       data-url="/stockOutcomeBill/view.do?id=${list.id}">查看</a>
                                </c:if>
                            </td>
                        </tr>
                    </c:forEach>

    ...
    <div class="ui_content">
        <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
            ...
            <tr>
                ...
                <td class="ui_text_lt">
                    <input type="text" value="${stockOutcomeBill.depot.name}" class="ui_input_txt02"/>
                </td>
            </tr>
            <tr>
                <td class="ui_text_rt" width="140">客户</td>
                <td class="ui_text_lt">
                    <input type="text" value="${stockOutcomeBill.client.name}" class="ui_input_txt02"/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <table class="edit_table" cellspacing="0" cellpadding="0" border="0" style="width: auto">
                        ...
                        <c:forEach items="${stockOutcomeBill.stockOutcomeBillItems}" var="stockOutcomeBillItem">
                            <tr>
                                <td></td>
                                <td>
                                    <input disabled="true" readonly="true"
                                           value="${stockOutcomeBillItem.product.name}" class="ui_input_txt02"
                                           tag="name"/>
                                ...
                                <td><input tag="remark" name=""
                                           class="ui_input_txt02" value="${stockOutcomeBillItem.remark}"/></td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    </table>

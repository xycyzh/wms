                    ...
                    <td>
                        ...
                        <table class="edit_table" cellspacing="0" cellpadding="0" border="0" style="width: auto">
                            ...
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <c:forEach items="${stockIncomeBill.stockIncomeBillItems}"
                                               var="stockIncomeBillItem">
                                        <tr>
                                            <td></td>
                                            <td>
                                                <input disabled="true" readonly="true"
                                                       value="${stockIncomeBillItem.product.name}"
                                            ...
                                            <td><input tag="remark" name=""
                                                       class="ui_input_txt02" value="${stockIncomeBillItem.remark}"/>
                                            </td>
                                            <td>
                                                <a href="javascript:;" class="removeItem">删除明细</a>
                                            </td>

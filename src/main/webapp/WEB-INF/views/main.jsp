...
<head>
    ...
    <script type="text/javascript" src="/js/plugins/jquery-zTree/jquery.ztree.core-3.4.js"></script>
...
<!-- side menu start -->
<div id="top_nav">
    当前位置：系统&nbsp;>&nbsp;<span id="here_area">业务模块</span>
</div>
<div id="main">
    <iframe name="right" id="rightMain" src="" frameborder="no" scrolling="auto" width="100%"
            height="100%"
